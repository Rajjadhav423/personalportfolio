  ...
  return (
    <section id="education" className="py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <CardSpotlight className="p-4 sm:p-6 md:p-8 max-w-4xl mx-auto">
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-start relative z-20">
                  ...
                  <div className="flex flex-wrap gap-1.5 sm:gap-2">
                    {coursework.map((course, idx) => (
                      <motion.span
                        ...
                        viewport={{ once: true }}
                        className="skill-badge px-2 sm:px-3 py-1 sm:py-1.5 rounded-full text-xs sm:text-sm"
                      >
                        {course}
                      </motion.span>
                    ))}
              ...
              <CardSpotlight className="p-4 sm:p-6 h-full">
                <div className="flex items-start gap-3 sm:gap-4 relative z-20">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-neutral-600 dark:text-neutral-400 text-xs sm:text-sm mb-1 sm:mb-2">{cert.issuer}</p>
