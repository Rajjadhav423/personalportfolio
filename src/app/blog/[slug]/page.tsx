...
import { PortfolioMDXRemote } from "@/components/ui/MDXRemote"; // We will create this wrapper
import { SectionHeading } from "@/components/ui/SectionHeading"; // Reuse for consistency if needed, or custom header
